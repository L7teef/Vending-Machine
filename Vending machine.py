...
products = [
    ...
    {"name": "Takis chips", "code": "A1", "price": 3.50, "quantity": 5},
    
    {"name": "Croissant", "code": "A2", "price": 1.00, "quantity": 1},
    
    {"name": "Galaxy Chocolate", "code": "A3", "price": 1.50, "quantity": 2},
    
    {"name": "Water", "code": "A4", "price": 1.50, "quantity": 1},
    
    {"name": "Lays Chips", "code": "B1", "price": 0.75, "quantity": 5},
    
    {"name": "Doritos", "code": "B2", "price": 1.75, "quantity": 8},
    
    {"name": "Cheetos", "code": "B3", "price": 2.75, "quantity": 9},
    
    {"name": "Pringles", "code": "B4", "price": 0.50, "quantity": 7},
]
...
while True:
    display_menu()
    code = input("Enter the code of the product you want to purchase and to end the purchase enter 'exit': ")
    if code == "exit":
        break
